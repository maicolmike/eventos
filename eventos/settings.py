...
import os
from decouple import config #para leer las variables de entorno desde el archivo .env
...
SECRET_KEY = 'django-insecure-9nzfp^1)4+4b0f1i9b@3pd$v!4wha)@qo4l7245oz@7@m+3&66'
...
TEMPLATES = [
    {
        ...
        #'DIRS': ['templates'], # usuario agrega 'templates'
         'DIRS': [os.path.join(BASE_DIR, 'templates')], # usuario agrega esta linea para que reconozca la carpeta templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# codigo agregado por el usuario
